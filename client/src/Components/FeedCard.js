  ...
  return (
    <div>
      ...
      <div>
          ...
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-red-700 dark:text-white">Donation Required</h5>
      ...
      <div>
          ...
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-red-700 dark:text-white">Mass Casulty</h5>
